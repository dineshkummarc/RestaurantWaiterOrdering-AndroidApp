...
import fortin.restaurant.digital.menu.view.ImageUtil;
...
public class RecycleViewAdapterNew extends RecyclerView.Adapter<RecycleViewAdapterNew.DataObjectHolder> {
  ...
  /*public  int  quan;*/
    ...
    public void onBindViewHolder(final DataObjectHolder holder, final int position) {
        ...
        holder.txtprice.setText(DataManager.currency+". "+custdisheslist.get(position).getPrice());


        ImageUtil.displayRoundImage(holder.imgdish, DataManager.URL + custdisheslist.get(position).getDishimage(), null);
        ...
        holder.btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(DataManager.dishorederlist != null) {
                    DataManager.dishorederlist.add(custorder);
                }else
                {
                    DataManager.dishorederlist = new ArrayList<DishOrderPojo>();
                    DataManager.dishorederlist.add(custorder);
                }
                        ...
                        Snackbar.with(activity) // context
                                ...
                                .actionListener(new ActionClickListener() {
                                    ...
                                    public void onActionClicked(com.nispok.snackbar.Snackbar snackbar) {
                                        ...
                                        DataManager.dishorederlist.remove(DataManager.dishorederlist.size()-1);
                                    }
